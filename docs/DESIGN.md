...
| 3 | **Givers** — block givers, ambient place givers, `/quest giver set`, proximity offer, `api.Quests` for StoryTeller. *Built 2026-09-07 (overnight); NPC givers via Cast the same afternoon; no floating labels yet.* | quests live in the world |
